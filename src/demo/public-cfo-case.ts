...
const evidence: Evidence[] = [
  ...
  { id: "ev-variable-costs-current", sourceType: "FILE", sourceFile: "dre-sintetica.csv", period: "2026-06", rawValue: 30_000, normalizedValue: 30_000, unit: "BRL", confidence: 1 },
  { id: "ev-fixed-costs-current", sourceType: "FILE", sourceFile: "dre-sintetica.csv", period: "2026-06", rawValue: 51_250, normalizedValue: 51_250, unit: "BRL", confidence: 1 },
...
const calculations: Calculation[] = [
  ...
  { id: "calc-principal-cost-line", formulaId: "principal_cost_line", formulaVersion: "1.0.0", period: "2026-06", inputRefs: ["ev-payroll-current", "ev-variable-costs-current", "ev-fixed-costs-current"], rawResult: 154_500, displayedResult: "R$ 154,5 mil", unit: "BRL", status: "PASS" },
...
const claims: Claim[] = [
  ...
  { id: "claim-principal-cost", statement: "A principal linha de custo é a folha, com R$ 154,5 mil no período atual, acima dos custos fixos e variáveis agregados.", type: "CALCULATION", evidenceRefs: ["calc-principal-cost-line"], confidence: 1 },
...
export function buildPublicCfoCaseState(question: string, previousQuestions: string[] = []): CaseState {
  ...
  return {
    ...
    metrics: { values: [
      ...
      { id: "principal_cost_line", period: "2026-06", value: 154_500, status: "AVAILABLE", unit: "BRL", evidenceRefs: ["calc-principal-cost-line"], calculationRef: "calc-principal-cost-line" },
